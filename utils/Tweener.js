...
Tweener.addTween = function ($obj, $params)
{
	var T = Tweener;
	...
	for (var p in T.def)
	{
		tp[p] = $params[p] ? $params[p] : T.def[p];
	}
	...
	if (tp.onStart)
	{
		if (tp.onStartParams)
		{
			tp.onStart.apply(null, tp.onStartParams);
		}
		else
		{
			tp.onStart();
	...
	T.twns.push(new T.Tween($obj, tp, prms, tgts));
	T.loop();
}
	...
	for (var i = 0; i < T.twns.length; i++)
	{
		...
		else
		{
			...
			for (var j = 0; j < t.prms.length; j++)
			{
				if (t.t > dur)
				{
					t.obj[t.prms[j]] = t.bgns[j] + t.cngs[j];
				}
				else
				{
					t.obj[t.prms[j]] = Tweener.easingFunctions[t.tp.transition](t.t, t.bgns[j], t.cngs[j], dur);
				}
			}
			if (t.tp.onUpdate)
			{
				if (t.tp.onUpdateParams)
				{
					t.tp.onUpdate.apply(null, t.tp.onUpdateParams);
				}
				else
				{
					t.tp.onUpdate();
			...
			if (t.t > dur)
			{
				...
				if (t.tp.onComplete)
				{
					if (t.tp.onCompleteParams)
					{
						t.tp.onComplete.apply(null, t.tp.onCompleteParams);
					}
					else
					{
						t.tp.onComplete();
...
Tweener.easingFunctions =
{
	...
	easeOutInCubic: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutCubic(t * 2, b, c / 2, d);
		}
	...
	easeOutInQuart: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutQuart(t * 2, b, c / 2, d);
		}
	...
	easeOutInQuint: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutQuint(t * 2, b, c / 2, d);
		}
	...
	easeOutInSine: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutSine(t * 2, b, c / 2, d);
		}
	...
	easeOutInExpo: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutExpo(t * 2, b, c / 2, d);
		}
	...
	easeOutInCirc: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutCirc(t * 2, b, c / 2, d);
		}
	...
	easeOutInElastic: function (t, b, c, d, a, p)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutElastic(t * 2, b, c / 2, d, a, p);
		}
	...
	easeOutInBack: function (t, b, c, d, s)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutBack(t * 2, b, c / 2, d, s);
		}
	...
	easeInOutBounce: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeInBounce(t * 2, 0, c, d) * .5 + b;
		}
		else
		{
			return Tweener.easingFunctions.easeOutBounce(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
		}
	},
	easeOutInBounce: function (t, b, c, d)
	{
		if (t < d / 2)
		{
			return Tweener.easingFunctions.easeOutBounce(t * 2, b, c / 2, d);
		}
